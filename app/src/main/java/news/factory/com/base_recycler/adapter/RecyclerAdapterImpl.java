...
import news.factory.com.base_recycler.view_holders.article_item_holder.ArticleItemHolder;
...
import news.factory.com.base_recycler.view_holders.article_categories.ArticleCategoriesHolder;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch(viewType){
            ...
            case RecyclerWrapper.TYPE_ARTICLE_CATEGORIES:
                return new ArticleCategoriesHolder(view, (AppCompatActivity) view.getContext());
